...
from TmallComment import tmall_jydq_comments
from toollib.logger_tmall_jydq import Logger
...
def startingOneSpider(spiderModel, db):
    try:
        tmall_jydq_comments.main(spiderModel.log_collection_name, spiderModel.product_index, spiderModel.page_nummber,
