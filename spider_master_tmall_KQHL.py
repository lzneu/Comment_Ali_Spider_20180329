...
from TmallComment import tmall_kqhl_comments
from toollib.logger_tmall_kqhl import Logger
...
def startingOneSpider(spiderModel, db):
    try:
        tmall_kqhl_comments.main(spiderModel.log_collection_name, spiderModel.product_index, spiderModel.page_nummber,
