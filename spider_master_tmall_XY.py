...
from TmallComment import tmall_xy_comments
...
def startingOneSpider(spiderModel, db):
    try:
        tmall_xy_comments.main(spiderModel.log_collection_name, spiderModel.product_index, spiderModel.page_nummber,
...
if __name__ == '__main__':
    ...
    for i in range(len(collection_name_list)):
        ...
        spider.python_name = 'tmall_xy_comments.py'
