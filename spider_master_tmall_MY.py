...
from TmallComment import tmall_my_comments
from toollib.logger_tmall_my import Logger
...
def startingOneSpider(spiderModel, db):
    try:
        tmall_my_comments.main(spiderModel.log_collection_name, spiderModel.product_index, spiderModel.page_nummber, spiderModel.catalog_collection_name, spiderModel.target_collexction_name, spiderModel.maxPage_num_control, db)
