...
from TmallComment import tmall_hf_comments
from toollib.logger_tmall_hf import Logger
...
def startingOneSpider(spiderModel, db):
    try:
        tmall_hf_comments.main(spiderModel.log_collection_name, spiderModel.product_index, spiderModel.page_nummber, spiderModel.catalog_collection_name, spiderModel.target_collexction_name, spiderModel.maxPage_num_control, db)
...
if __name__ == '__main__':
    ...
    collection_name_list = COLLECTION_NAME_LIST_HF
    ...
    for i in range(len(collection_name_list)):
        ...
        spider.python_name = 'tmall_hf_comments.py'
